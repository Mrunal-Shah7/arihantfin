...
export const Careers = () => {
  ...
  return (
    <section id="careers" className="p-4 sm:p-8">
        ...
        <div className="max-w-3xl mx-auto mt-6 sm:mt-12">
          <Card className="shadow-lg">
            ...
            <CardContent className="pt-4 sm:pt-6 space-y-4 sm:space-y-6">
              ...
              <div>
                <h3 className="font-semibold text-arihant-secondary text-xl mb-2 sm:mb-4 text-center">
                  📌 Current Openings:
                </h3>
                <ul className="list-disc list-inside space-y-1 sm:space-y-2 max-w-md mx-auto">
              ...
              <div className="bg-arihant-gray/50 p-4 sm:p-6 rounded-lg text-center space-y-1 sm:space-y-2">
