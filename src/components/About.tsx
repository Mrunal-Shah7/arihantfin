    ...
    <section id="about" className="section-padding">
      <div className="container mx-auto">
        ...
        <div className="mt-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 h-full">
              ...
              <p className="text-gray-700">
                To simplify finance by offering clear, structured, and custom solutions that enable our clients to grow with confidence.
                    ...
                    <div className="bg-arihant-gray/50 rounded-lg p-8 mb-12">
          ...
          {/* Leader 1 */}
          <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-arihant-primary transition-colors">
            <img
              src="/assets/images/rushabh-shah.jpg" // Adjust the path to your image
              alt="Rushabh Shah"
          ...
          <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-arihant-primary transition-colors">
            <img
              src="/assets/images/ashish-shah.jpg" // Adjust the path to your image
              alt="Ashish Shah"
              className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"
            />
          ...
          <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-arihant-primary transition-colors">
            <img
              src="/assets/images/ankit-shah.jpg" // Adjust the path to your image
              alt="Ankit Shah"
              className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"
            />
          ...
          <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-arihant-primary transition-colors">
            <img
              src="/assets/images/miti-shah.jpg" // Adjust the path to your image
              alt="Miti Shah"
              className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"
            />
          ...
          <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-arihant-primary transition-colors">
            <img
              src="/assets/images/ankit-mehta.jpg" // Adjust the path to your image
              alt="Ankit Mehta"
              className="w-24 h-24 rounded-full mx-auto mb-4 object-cover"
            />
