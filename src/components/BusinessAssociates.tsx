            ...
            <CardContent className="pt-4 sm:pt-8 pb-4 sm:pb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
                ...
                <div className="bg-white border border-gray-200 rounded-md p-2 sm:p-4 text-center shadow-sm hover:border-arihant-primary hover:shadow-md transition-all">
                  <img
                    src="https://github.com/Mrunal-Shah7/arihantfin/blob/main/public/hdfc.jpeg?raw=true"
                    alt="HDFC Bank Icon"
                ...
                <div className="bg-white border border-gray-200 rounded-md p-2 sm:p-4 text-center shadow-sm hover:border-arihant-primary hover:shadow-md transition-all">
                  <img
                    src="https://github.com/Mrunal-Shah7/arihantfin/blob/main/public/icici.png?raw=true"
                    alt="ICICI Bank Icon"
                    className="w-8 h-8 mx-auto mb-2 object-contain"
                  />
                ...
                <div className="bg-white border border-gray-200 rounded-md p-2 sm:p-4 text-center shadow-sm hover:border-arihant-primary hover:shadow-md transition-all">
                  <img
                    src="https://github.com/Mrunal-Shah7/arihantfin/blob/main/public/axis.png?raw=true"
                    alt="Axis Bank Icon"
                    className="w-8 h-8 mx-auto mb-2 object-contain"
                  />
